...
export default class Bullet extends Entity{
    ...
    explode(game,baseSize){
        for (let i = 0; i < 20; i++){
            ...
            var p = new Particle(game.level,this.position.x,this.position.y,this.position.z,MathUtil.getRandom(0.5,1.9),{x:MathUtil.getRandom(-0.3,0.3), y: Math.random()/1.5, z: MathUtil.getRandom(-0.3,0.3)},0.05,[c[0],c[1],c[2],0.9],baseSize+MathUtil.getRandom(0.005,0.01));
