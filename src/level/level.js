    ...
    constructor(game,size,ambientLight,height,wallTint,floorTint,glassTint,levelData,name){
        ...
        for (let x = 0; x < size; x++) {
            for (let z = 0; z < size; z++){
                ...
                else if (levelChar == "4") this.setStructure(x,z,Structures.floors[3]);
                else if (levelChar == "5") this.setStructure(x,z,Structures.floors[4]);
                else if (levelChar == "6") this.setStructure(x,z,Structures.floors[5]);
                else if (levelChar == "7") this.setStructure(x,z,Structures.floors[6]);
                else if (levelChar == "8") this.setStructure(x,z,Structures.floors[7]);
